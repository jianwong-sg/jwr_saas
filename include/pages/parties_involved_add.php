...
' 
		...
		'text' => array(
			'type' => 'text',
			'label' => array(
				'text' => '<DIV><INPUT id="check" type="checkbox">&nbsp;<EM>Check this box if Billing Address same as Mailing Address.</EM></DIV>',
				'type' => 0 
			),
			'editedByRte' => false 
		),
