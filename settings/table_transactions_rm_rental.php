...
$runnerTableSettings['transactions_rm_rental'] = array(
		...
		'category' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupWhere' => 'tx_type!=\'ASSIGNMENT\' && tx_type!=\'ROOM RENTAL\'',
					'fileThumbnailSize' => 150,
					'fileMaxNumber' => 1,
					'fileThumbnailField' => 'th',
					'dateFirstYearFactor' => 30,
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['transactions_rm_rental'] = array(
	'tableCaption' => 'Transactions - Rm Rental',
	'fieldLabels' => array(
		'id' => 'Txn ID',
		'category' => 'Txn Type',
		'prop_type' => 'Prop Type',
