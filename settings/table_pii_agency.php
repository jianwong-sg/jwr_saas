...
$runnerTableSettings['pii_agency'] = array(
	'name' => 'pii_agency',
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['pii_agency'] = array(
	'tableCaption' => 'PII (Agency)',
	'fieldLabels' => array(
		'category' => 'Category',
		'docuserid' => 'Docuserid',
		'filenames' => 'Filenames',
	...
	'pageTitles' => array(
		'add' => 'P I Ins (Agency), Add new',
		'edit' => 'P I Ins (Agency), Edit [{%id}]',
		'list' => 'P I Ins (Agency)',
		'print' => 'P I Ins (Agency)',
		'search' => 'P I Ins (Agency) - Advanced search',
		'view' => 'P I Ins (Agency) [{%id}]' 
	) 
);
}
?>