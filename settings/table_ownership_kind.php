...
$runnerTableSettings['ownership_kind'] = array(
	'name' => 'ownership_kind',
...
FROM ownership_kind',
		...
		'fieldListSql' => 'id,
	kind',
		'fromListSql' => 'FROM ownership_kind',
		'orderBySql' => '',
		'tailSql' => '' 
	),
	'hasEvents' => true,
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['ownership_kind'] = array(
	'tableCaption' => 'Ownership Kind',
	'fieldLabels' => array(
		'id' => 'Id',
		'kind' => 'Kind' 
	),
