...
$runnerTableSettings['interpretation'] = array(
	'name' => 'interpretation',
...
ORDER BY `language`',
		...
		'fieldListSql' => 'id,
`language`',
		'fromListSql' => 'FROM interpretation',
		'orderBySql' => 'ORDER BY `language`',
		'tailSql' => '' 
	),
	'hasEvents' => true,
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['interpretation'] = array(
	'tableCaption' => 'Interpretation',
	'fieldLabels' => array(
		'id' => 'Id',
		'language' => 'Language' 
	),
