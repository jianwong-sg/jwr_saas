...
$runnerTableSettings['str'] = array(
	...
	'tableOwnerIdField' => 'salesperson_name',
...
represnting,
party_id,
CONCAT(Ifnull(indi_name,""), Ifnull(entity_name,"")) AS subject_name
FROM str
ORDER BY filing_date DESC',
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupAutofillFields' => array( 
						array(
							'masterField' => 'ea_address',
							'lookupField' => 'agency_address' 
						),
						array(
							'masterField' => 'ea_contact',
							'lookupField' => 'agency_tel' 
						),
						array(
							'masterField' => 'ea_email',
							'lookupField' => 'agency_email' 
						) 
					),
					'fileThumbnailSize' => 150,
					'fileMaxNumber' => 1,
		...
		'ea_email' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupTable' => 'agency',
					'lookupTableConnection' => 'Tables',
					'lookupLinkField' => 'agency_email',
					'lookupDisplayField' => 'agency_email',
					'lookupAllowEdit' => true,
					'lookupControlType' => 1,
					'lookupDependent' => true,
					'lookupDependentFields' => array( 
		...
		'entity_name' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'autoUpdateValue' => '$_SESSION["client_name"]',
					'textboxMaxLenth' => 50,
					'textHTML5Input' => '0',
					'lookupType' => 2,
	...
	$value = implode(",",$arr);',
		...
		'prop_tenure' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'autoUpdateValue' => '$_SESSION["prop_tenure"]',
					'textboxSize' => 120,
					'textboxMaxLenth' => 15,
					'textHTML5Input' => '0',
					'lookupType' => 2,
		...
		'prop_type' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'autoUpdateValue' => '$_SESSION["prop_type"]',
					'textboxSize' => 120,
					'textboxMaxLenth' => 15,
					'textHTML5Input' => '0',
					'lookupType' => 2,
					...
					'lookupTable' => 'transactions',
					'lookupTableConnection' => 'Tables',
					'lookupLinkField' => 'prop_type',
					'lookupDisplayField' => 'prop_type',
					'lookupControlType' => 1,
					'lookupDependent' => true,
					'lookupDependentFields' => array( 
						array(
		...
		'transact_type' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'autoUpdateValue' => '$_SESSION["transact_type"]',
					'textboxSize' => 120,
					'textboxMaxLenth' => 15,
					'textHTML5Input' => '0',
					'lookupType' => 2,
		...
		'transact_price' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'autoUpdateValue' => '$_SESSION["transact_price"]',
					'textboxSize' => 100,
					'textboxMaxLenth' => 15,
					'textHTML5Input' => '0',
					'lookupType' => 2,
					'lookupTable' => 'transactions',
					'lookupTableConnection' => 'Tables',
					'lookupLinkField' => 'transacted_price',
					'lookupDisplayField' => 'transacted_price',
					'lookupDependent' => true,
					'lookupDependentFields' => array( 
						array(
							'masterField' => 'id_tx',
		...
		'valuation' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'autoUpdateValue' => '$_SESSION["valuation"]',
					'textboxSize' => 100,
					'textboxMaxLenth' => 15,
					'textHTML5Input' => '0',
					'lookupType' => 2,
					'lookupTable' => 'transactions',
					'lookupTableConnection' => 'Tables',
					'lookupLinkField' => 'valuation_price',
					'lookupDisplayField' => 'valuation_price',
					'lookupControlType' => 1,
					'lookupFreeInput' => true,
					'lookupDependent' => true,
					'lookupDependentFields' => array( 
		...
		'lease_period' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'autoUpdateValue' => '$_SESSION["lease_period"]',
					'textboxSize' => 150,
					'textboxMaxLenth' => 15,
					'textHTML5Input' => '0',
					'lookupType' => 2,
					'lookupTable' => 'transactions',
					'lookupTableConnection' => 'Tables',
					'lookupLinkField' => 'lease_duration_no',
					'lookupDisplayField' => 'lease_duration_no',
					'lookupDependent' => true,
					'lookupDependentFields' => array( 
						array(
							'masterField' => 'id_tx',
					...
					'lookupAutofillFields' => array( 
						array(
							'masterField' => 'lease_period_unit',
							'lookupField' => 'lease_duration_unit' 
						) 
					),
					'fileThumbnailSize' => 150,
					'fileMaxNumber' => 1,
		...
		'lease_period_unit' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'autoUpdateValue' => '$_SESSION["lease_period_unit"]',
					'textboxMaxLenth' => 50,
					'textHTML5Input' => '0',
					'fileMaxNumber' => 1,
					'fileThumbnailField' => 'th',
		...
		'salesperson_name' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupTable' => 'transactions',
					'lookupTableConnection' => 'Tables',
					'lookupLinkField' => 'salesperson_name',
					'lookupDisplayField' => 'salesperson_name',
					'lookupControlType' => 1,
					'lookupDependent' => true,
					'lookupDependentFields' => array( 
						array(
		...
		'salesperson_nric' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupTable' => 'transactions',
					'lookupTableConnection' => 'Tables',
					'lookupLinkField' => 'salesperson_nric',
					'lookupDisplayField' => 'salesperson_nric',
					'lookupControlType' => 1,
					'lookupDependent' => true,
					'lookupDependentFields' => array( 
						array(
		...
		'customer_type' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'autoUpdateValue' => '$_SESSION["cust_type"]',
					'textboxSize' => 120,
					'textboxMaxLenth' => 50,
					'textHTML5Input' => '0',
					'lookupType' => 0,
		...
		'represnting' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'autoUpdateValue' => '$_SESSION["representing"]',
					'textboxSize' => 100,
					'textboxMaxLenth' => 50,
					'textHTML5Input' => '0',
					'lookupType' => 2,
					'lookupTable' => 'cdd_measures',
					'lookupTableConnection' => 'Tables',
					'lookupLinkField' => 'representing',
					'lookupDisplayField' => 'representing',
					'lookupControlType' => 1,
					'lookupDependent' => true,
					'lookupDependentFields' => array( 
						array(
							'masterField' => 'id_tx',
							'lookupField' => 'id_cddmeasures' 
						) 
					),
					'fileThumbnailSize' => 150,
					'fileMaxNumber' => 1,
		...
		'party_id' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'autoUpdateValue' => '$_SESSION["custid"]',
					'validateAs' => 'Number',
					'textboxSize' => 100,
					'textHTML5Input' => '0',
					'lookupType' => 2,
					'lookupTable' => 'cdd_measures',
					'lookupTableConnection' => 'Tables',
					'lookupLinkField' => 'customer_nric',
					'lookupDisplayField' => 'customer_nric',
					'lookupControlType' => 1,
					'lookupDependent' => true,
					'lookupDependentFields' => array( 
						array(
		...
		'subject_name' => array(
			'name' => 'subject_name',
			'goodName' => 'subject_name',
			'strField' => 'subject_name',
			'index' => 55,
			'sqlExpression' => 'CONCAT(Ifnull(indi_name,""), Ifnull(entity_name,""))',
			'viewFormats' => array(
				'view' => array(
					'numberFractionalDigits' => 0 
				) 
...
ORDER BY filing_date DESC',
		...
		'fieldList' => array( 
			...
			array(
				'sql' => 'CONCAT(Ifnull(indi_name,""), Ifnull(entity_name,""))',
				'parsed' => true,
				'type' => 'FieldListItem',
				'alias' => 'subject_name',
				'expression' => array(
					...
					'arguments' => array( 
						array(
							'sql' => 'Ifnull(indi_name,"")',
							'parsed' => true,
							'type' => 'NonParsedEntity' 
						),
						array(
							'sql' => 'Ifnull(entity_name,"")',
							'parsed' => true,
							'type' => 'NonParsedEntity' 
						) 
					),
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['str'] = array(
	'tableCaption' => 'Suspicious Txn Report',
	'fieldLabels' => array(
		'id' => 'Id',
		...
		'entity_contact' => 'Entity Contact No.',
	...
	'fieldTooltips' => array(
		...
		'ea_contact' => '',
		'ea_email' => '',
		'relationship_with_subject' => 'E.g: Estate agent providing brokage services in Buy/Sell/Lease of property.',
		'officer_name1' => '',
		'designation1' => '',
		'report_ref' => '',
		'officer_name2' => '',
		...
		'entity_name' => '',
		'country_reg' => '',
		'reg_no' => 'To begin, click Reg. No. to select record',
		'reg_date' => '',
		'entity_address' => '',
		'entity_foreign_address' => '',
		'entity_contact' => '',
		...
		'bo_name' => '',
		'indi_name' => '',
		'indi_id' => 'To begin, click Customer ID to select ID',
		'indi_dob' => '',
		'indi_nationalty' => '',
		'indi_address' => '',
		'indi_address_foreign' => '',
		...
		'lease_period' => '',
		'lease_period_unit' => '',
		'deposit' => 'Input only digit. E.g 88000',
		'salesperson_name' => '',
		'salesperson_nric' => '',
		'suspicious_amount' => '',
		'suspicious_date' => '',
		'description' => 'E.g. Sale of a landed property',
		'reason_suspicion' => '',
		'other_info' => '',
		'docs_attach' => '',
		'id_tx' => '',
	...
	'pageTitles' => array(
		'list' => 'Suspicious Transaction Report (STR)' 
	) 
);
}
?>