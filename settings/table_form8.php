...
$runnerTableSettings['form8'] = array(
	'name' => 'form8',
	'type' => 1,
	'shortName' => 'form8',
	...
	'fields' => array(
		...
		'form_name' => array(
			...
			'editFormats' => array(
				'edit' => array(
					'format' => 'Readonly',
					'defaultValue' => '"Council for Estate Agencies, Singapore | Prescribed Estate Agency Agreement: Form 8"',
					'autoUpdateValue' => '"Council for Estate Agencies, Singapore | Prescribed Estate Agency Agreement: Form 8"',
					'textboxSize' => 500,
					'textboxMaxLenth' => 100,
					'textHTML5Input' => '0',
					'fileThumbnailSize' => 150,
		...
		'lease_tenure2' => array(
			...
			'editFormats' => array(
				'edit' => array(
					'format' => 'Lookup wizard',
					'denyDuplicateMessage' => array(
						'text' => '%value% already exists, please select from record.',
						'type' => 0 
					),
					'textboxSize' => 120,
					'textboxMaxLenth' => 50,
...
$this->settings["saveEmptyImage"] = false;' 
		...
		'landlord1_address' => array(
			...
			'sourceSingle' => 'landlord1_address',
			'index' => 88,
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['form8'] = array(
	'tableCaption' => 'Prescribed Form 8',
	'fieldLabels' => array(
		'id' => 'ID',
		'id_tx' => 'Id Txn',
		'id_form' => 'Id Form',
		...
		'salesperson_contact' => 'Telephoe number:',
		'estateagent' => 'Name of Estate Agent<sup>(4):',
		...
		'title' => '',
		'form_name' => 'Form Name',
		'tenant1' => 'Tenant(1) Name:',
		'tenant1_id' => 'NRIC No.<sup>(4)</sup>:',
		'tenant1_address' => 'Address:',
		'tenant2' => 'Tenant(2) Name:',
		'tenant2_id' => 'NRIC No.<sup>(4)</sup>:',
		'tenant2_address' => 'Address:',
		'tenant3' => 'Tenant(3) Name:',
		'tenant3_id' => 'NRIC No.<sup>(4)</sup>:',
		'tenant3_address' => 'Address:',
		'tenant4' => 'Tenant(4) Name:',
		'tenant4_id' => 'NRIC No.<sup>(4)</sup>:',
		'tenant4_address' => 'Address:',
		'estateagent_address' => 'Estateagent Address',
		'gst_include' => 'Gst Include',
		'salesperson_ic' => 'NRIC No.<sup>(4)</sup>:',
		...
		'renewal_percent' => 'Lease Tenure2',
		'lease_tenure2' => 'Lease Tenure2',
		'expiry_date' => 'Expiry Date',
		'effect_date' => 'Effect Date',
		'renewal_term2' => 'Renewal Term',
		'lease_tenure' => 'Lease Tenure',
		'lease_tenure3' => 'Lease Tenure',
		'docuserid' => 'Docuserid',
		...
		'sign_date3' => 'Date:',
		'sign_date4' => 'Date:',
		'interpreterID1' => 'Interpreter\'s NRIC No.<sup>(4)</sup>:',
		'interpreterID2' => 'Interpreter\'s NRIC No.<sup>(4)</sup>:',
		'interpreterID3' => 'Interpreter\'s NRIC No.<sup>(4)</sup>:',
		'interpreterID4' => 'Interpreter\'s NRIC No.<sup>(4)</sup>:',
		...
		'sign_tenant1' => 'Sign by Tenant (1)',
		'sign_tenant2' => 'Sign by Tenant (2)',
		'sign_tenant3' => 'Sign by Tenant (3)',
		'sign_tenant4' => 'Sign by Tenant (4)',
		'sign7' => '',
		'sign8' => '' 
	),
	'fieldTooltips' => array(
