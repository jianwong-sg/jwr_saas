...
$runnerTableSettings['parties_involved_lcsc'] = array(
		...
		'marketing_rights' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'autoUpdateValue' => '$_SESSION["marketingrights"]',
					'textboxMaxLenth' => 50,
					'textHTML5Input' => '0',
					'fileMaxNumber' => 1,
					'fileThumbnailField' => 'th',
...
ORDER BY id DESC',
		...
		'fieldList' => array( 
			array(
				...
				'expression' => array(
					...
					'parsed' => true,
					'type' => 'SQLField',
					'table' => 'jwresour_jwr_saas_db_jwrealty.parties_involved',
					'name' => 'id' 
				),
				'encrypted' => false,
				'columnName' => 'id' 
		...
		'fromList' => array( 
			array(
				'sql' => 'jwresour_jwr_saas_db_jwrealty.parties_involved',
				'parsed' => true,
				'type' => 'FromListItem',
				'table' => array(
					'sql' => 'jwresour_jwr_saas_db_jwrealty.parties_involved',
					...
					'name' => 'jwresour_jwr_saas_db_jwrealty.parties_involved' 
				),
				'joinOn' => array(
					'sql' => '',
					'parsed' => false,
...
representing,
marketing_rights',
		'fromListSql' => 'FROM jwresour_jwr_saas_db_jwrealty.parties_involved',
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['parties_involved_lcsc'] = array(
	'tableCaption' => 'Parties Involved Lcsc',
	'fieldLabels' => array(
		'id' => 'Id',
		'id_tx' => 'Id Txn',
		'name' => 'Name',
