...
$runnerTableSettings['transact_type'] = array(
	'name' => 'transact_type',
...
FROM transact_type',
		...
		'fieldListSql' => 'id,
	tx_type',
		'fromListSql' => 'FROM transact_type',
		'orderBySql' => '',
		'tailSql' => '' 
	),
	'hasEvents' => true,
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['transact_type'] = array(
	'tableCaption' => 'Transact Type',
	'fieldLabels' => array(
		'id' => 'Id',
		'tx_type' => 'Txn Type' 
	),
