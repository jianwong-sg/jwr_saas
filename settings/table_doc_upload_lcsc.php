...
$runnerTableSettings['doc_upload_lcsc'] = array(
	...
	ID,
	id_tx
FROM jwresour_jwr_saas_db_jwrealty.doc_upload',
	'keyFields' => array( 
		'ID' 
	),
...
FROM jwresour_jwr_saas_db_jwrealty.doc_upload',
		...
		'fieldList' => array( 
			array(
				...
				'expression' => array(
					...
					'parsed' => true,
					'type' => 'SQLField',
					'table' => 'jwresour_jwr_saas_db_jwrealty.doc_upload',
					'name' => 'date_added' 
				),
				'encrypted' => false,
		...
		'fromList' => array( 
			array(
				'sql' => 'jwresour_jwr_saas_db_jwrealty.doc_upload',
				'parsed' => true,
				'type' => 'FromListItem',
				'table' => array(
					'sql' => 'jwresour_jwr_saas_db_jwrealty.doc_upload',
					...
					'name' => 'jwresour_jwr_saas_db_jwrealty.doc_upload' 
				),
				'joinOn' => array(
					'sql' => '',
					'parsed' => false,
	...
	ID,
	id_tx',
		'fromListSql' => 'FROM jwresour_jwr_saas_db_jwrealty.doc_upload',
		'orderBySql' => '',
		'tailSql' => '' 
	),
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['doc_upload_lcsc'] = array(
	'tableCaption' => 'Doc Upload Lcsc',
	'fieldLabels' => array(
