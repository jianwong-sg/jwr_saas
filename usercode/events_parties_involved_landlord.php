<?php
class eventclass_parties_involved_landlord  extends TableEventsBase {
...
pps_result='',namelist_cust='',namelist_result='',alertlist_cust='',
alertlist_result='',cdd_check_result='' WHERE id='".$deleted_values["id_tx"]."' ");
