Runner.buttonEvents['192319'] = function( pageObj, proxy, pageid ) {
	var gid = '192319';
	...
	if ( !pageObj.buttonEventBefore[ gid ] ) {
		pageObj.buttonEventBefore[ gid ] = function( params, ctrl, pageObj, proxy, pageid, rowData, row, submit ) {		
			var ajax = ctrl;
			var ctrpostcode = Runner.getControl(pageid, "prop_postal");
...
var ctrBuildingDescription = Runner.getControl(pageid, "prop_address");
