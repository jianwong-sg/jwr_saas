...
$("#view1_buyer1").css('text-decoration','underline');
$("#view1_buyer1_id").css('text-decoration','underline');
$("#view1_buyer1_address").css('text-decoration','underline');
$("#view1_date_sp").css('text-decoration','underline');
