Runner.buttonEvents['192299'] = function( pageObj, proxy, pageid ) {
	var gid = '192299';
...
{
alert('Please select listing to De-activate')
}			
		}
	}
	...
	if ( !pageObj.buttonEventAfter[ gid ] ) {
		pageObj.buttonEventAfter[ gid ] = function( result, ctrl, pageObj, proxy, pageid, rowData, row, params ) {
			...
			if(result["c"])
{
var message = result["c"] + " Listing(s) De-activated and moved to 'Past' folder.";
alert(message);
