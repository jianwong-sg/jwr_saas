Runner.buttonEvents['192322'] = function( pageObj, proxy, pageid ) {
	var gid = '192322';
	...
	if ( !pageObj.buttonEventBefore[ gid ] ) {
		pageObj.buttonEventBefore[ gid ] = function( params, ctrl, pageObj, proxy, pageid, rowData, row, submit ) {		
			var ajax = ctrl;
			var ctrpostcode = Runner.getControl(pageid, "postal");
var postcode = ctrpostcode.getValue();
params["postal"] =postcode;			
		}
	}
...
var ctrBuildingDescription = Runner.getControl(pageid, "address");
